              ...
              <div className="mb-7 w-full space-y-3">
                ...
                >
                  ...
                  <div className="min-w-0 flex-1 text-start">
                    <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-primary/70">{t("call")}</p>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1 text-start">
                    <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-primary/70">{t("location")}</p>
